<div align="center">
  <h1>⚽ FC Burger Dreux – Rapport Technique</h1>
  <p><strong>Phase #1 | Groupe : Chaabaoui Qays, Madrassi Ayman</strong></p>
  <p><em>Date : 22 février 2026</em></p>
</div>
...
* **`profil.html`** : Espace personnel présenté sous forme de "Licence de joueur".
* **`style.css`** : Fichier unique gérant l'intégralité de la charte graphique.

## Spécifications Techniques

### Charte Graphique (CSS)
* **Couleurs Officielles :** Utilisation de variables CSS (`:root`) pour le **Bleu Dreux (#0055A4)** et le **Vert Terrain (#2ECC71)**.
* **Mise en page :** Utilisation de **Flexbox** pour la navigation et de **CSS Grid** pour les cartes produits.
* **Effet Panini :** Animations avec `transform` et `transition` pour simuler des cartes à collectionner.
...
---
<div align="center">
  <p><em>Projet réalisé dans le cadre de la Phase #1 du programme Creative Yumland.</em></p>
</div>
