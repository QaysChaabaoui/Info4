...
if (isset($_GET['action']) && $_GET['action'] === 'retirer' && isset($_GET['id'])) {
    ...
    if (isset($_SESSION['panier'][$id_a_retirer])) {
        unset($_SESSION['panier'][$id_a_retirer]);
    }
        ...
        <section class="cart-section">
            ...
            <div class="cart-container">
                        ...
                        if (isset($_SESSION['panier']) && !empty($_SESSION['panier'])):
                            foreach ($_SESSION['panier'] as $id => $details):
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="panier.php?action=retirer&id=<?php echo $id; ?>" class="btn-remove-item"
                            ...
                            <tr>
                                <td colspan="5" style="text-align:center; padding: 30px;">
                                    ...
                                    <a href="menu.php" style="color: var(--bleu-dreux); font-weight: bold;">Retourner à la
                                        Compo</a>
                                </td>
                            </tr>
                        <?php endif; ?>
                ...
                <div class="order-timing"
                    style="margin-top: 30px; padding: 20px; border: 2px dashed var(--bleu-dreux); border-radius: 10px; text-align: left;">
                    ...
                    <form action="paiement.php" method="POST">
                        ...
                        <div class="form-group" style="margin-top: 10px;">
                            ...
                            <label for="plus-tard">📅 Programmer le match :</label>
                            <input type="datetime-local" name="date_livraison" class="form-input-custom"
                                style="margin-top: 10px;">
                        </div>

                        <div class="cart-total" style="margin-top: 30px;">
                            <h3>Total du Match : <span><?php echo number_format($total_general, 2, ',', ' '); ?>
                                    €</span></h3>
